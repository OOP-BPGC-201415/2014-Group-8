...
<!--	 jQuery 
	...
	<form accept-charset="UTF-8" role="form" method="POST" action="<c:url value="/client/admin"/>">
	    <fieldset>
		<div class="form-group">
		    <input class="form-control" placeholder="Username" name="username" type="text" autofocus="true" autocomplete="true">
		</div>
		<div class="form-group">
